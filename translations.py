...
T = {
    "FR": {
        ...
        "source_rate_full": "Source : Banque de France / BCE — Coût du crédit à l'habitat des particuliers, toutes durées confondues (crédits nouveaux, statistiques MIR, série M.FR.B.A2C.AM.R.A.2250.EUR.N). Équivalent ouvert et téléchargeable de l'Observatoire Crédit Logement.",
        ...
        "credit_trace": "Taux Crédit Habitat (toutes durées)",
        "chart_insee_sub": "CVS, base 100 = moyenne de longue période",
        "chart_rates_sub": "taux crédit habitat (toutes durées) · Euribor 3 mois · OAT 10 ans — en %",
    ...
    "EN": {
        ...
        "macro_desc": "Macroeconomic context and financing-condition indicators: household confidence index (INSEE), average nominal housing-loan rates across all loan terms (Banque de France / ECB), 3-month Euribor and 10-year OAT (ECB), together with household housing-purchase intentions and the ILO unemployment rate (INSEE).",
        ...
        "source_rate_full": "Source: Banque de France / ECB — Cost of borrowing for house purchase, all loan terms combined (new business, MIR statistics, series M.FR.B.A2C.AM.R.A.2250.EUR.N). Open, downloadable equivalent of the Crédit Logement Observatory rate.",
        ...
        "credit_trace": "Housing Loan Rate (all terms)",
        "chart_insee_sub": "SA, base 100 = long-term average",
        "chart_rates_sub": "housing-loan rate (all terms) · 3-month Euribor · 10-year OAT — in %",
