...
T = {
    "FR": {
        ...
        "tab_atelier": "🔬 Atelier exploratoire",
        "tab_donnees": "⚙️ Données & Export",
        "subtab_timelag": "⏱️ Time Lag",
        "subtab_composite": "🧪 Composite",
        "subtab_source": "📂 Sources & Imports",
        "subtab_export": "💾 Export SAP IBP",
        "atelier_caption": "Bac à sable exploratoire : corrélations décalées (Time Lag) et indicateur composite pondéré. Pour le modèle calibré automatiquement, voir « 📡 Prévision & Scénarios ».",
        "donnees_caption": "Consultation et import des données sources, puis export des indicateurs vers SAP IBP.",
        ...
        "alignment_title": "Alignement : {ind} (décalé de {lag} mois) vs {bench}",
        ...
        "composite_plot_title": "Indicateur Avancé Composite (Normalisé 0-100) vs {bench}",
        ...
        "src_simple_lag": "Indicateur Simple Décalé (Atelier — Time Lag)",
        "src_composite": "Indicateur Composite (Atelier — Composite)",
        "no_simple_lag": "⚠️ Aucun indicateur décalé n'a été calculé. Rendez-vous dans « 🔬 Atelier exploratoire » (sous-onglet Time Lag) pour en générer un.",
        "no_composite": "⚠️ Aucun indicateur composite n'a été créé. Rendez-vous dans « 🔬 Atelier exploratoire » (sous-onglet Composite) pour en configurer un.",
    ...
    "EN": {
        ...
        "tab_atelier": "🔬 Exploratory Workshop",
        "tab_donnees": "⚙️ Data & Export",
        "subtab_timelag": "⏱️ Time Lag",
        "subtab_composite": "🧪 Composite",
        "subtab_source": "📂 Sources & Imports",
        "subtab_export": "💾 SAP IBP Export",
        "atelier_caption": "Exploratory sandbox: lagged correlations (Time Lag) and a weighted composite indicator. For the auto-calibrated model, see '📡 Forecast & Scenarios'.",
        "donnees_caption": "Browse and import the source data, then export indicators to SAP IBP.",
        ...
        "alignment_title": "Alignment: {ind} (shifted by {lag} months) vs {bench}",
        ...
        "composite_plot_title": "Composite Leading Indicator (Normalized 0-100) vs {bench}",
        ...
        "src_simple_lag": "Shifted Simple Indicator (Workshop — Time Lag)",
        "src_composite": "Composite Indicator (Workshop — Composite)",
        "no_simple_lag": "⚠️ No shifted simple indicator calculated. Go to the '🔬 Exploratory Workshop' (Time Lag sub-tab) to generate one.",
        "no_composite": "⚠️ No composite indicator created. Go to the '🔬 Exploratory Workshop' (Composite sub-tab) to configure one.",
